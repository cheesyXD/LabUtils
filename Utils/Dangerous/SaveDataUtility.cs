...
namespace LabUtils.Utils.Dangerous
{
    internal class SaveDataUtility : Utility
    {
        ...
        {
            Page saveDataUtility = UICore.DangerousPage.CreatePage("Save Data", OverrideColor.red);
            // unlcoks every fuckin thing lad
            var unlocks = saveDataUtility.CreatePage("Player Unlocks", Color.white);
            ...
            var progession = saveDataUtility.CreatePage("Player Progession", Color.white);
